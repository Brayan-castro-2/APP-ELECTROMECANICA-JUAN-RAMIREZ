                    ...
                    {filteredItems.map((item) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                {item.showBadge && FEATURE_FLAGS.showNewBadges && <NewBadge />}
                            </Link>
                        );
                    })}
                </nav>
                        ...
                        {filteredItems.map((item) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    {item.showBadge && FEATURE_FLAGS.showNewBadges && (
                                        <span className="absolute -top-1 -right-1 bg-gradient-to-r from-blue-500 to-cyan-500 text-white text-[8px] font-bold px-1.5 py-0.5 rounded-full animate-pulse">
                                            NEW
                                        </span>
                                    )}
                                </Link>
